 ...
 * @author Muser01
 */
public class cviewprofilem extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String query=null;
             ...
             query="select PROFILE_ID,NAME,AGE,GENDER,RELIGION,EMAIL,ADDRESS,CITY,STATE,COUNTRY,PHONE,LTELUGU,LHINDI,LENGLISH,LTAMIL,LOTHERS,MSTATUS,EDUCATION,QUALIFICATION,LIVE,COOK,SWIM,DRIVE,PREVEMP,ABNANNY,ESALARY,LEAVESPM from maid where PROFILE_ID = '"+fid+"'and STATUS!='allocated'";
            ...
            while(rs.next()){
                    ...
                    srows=true;
                    out.println("<h1 ><font color='yellow'>THE FOLLOWING IS THE PROFILE OF THE MAID/NANNY</font></h1>");
                    ...
                    out.println("<tr ><td class='profiledec1'>ABOUT NANNY/MAID    :"+rs.getString(25)+"</td></tr>");
            ...
            if(!(srows))
                out.println("<h1><font color='yellow'>No such profile ID exists</font></h1>");
                    out.println("</body>");
                    out.println("</html>");
